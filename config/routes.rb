...
Rails.application.routes.draw do
  ...
  resources :user do
    # member do
    #   get 'password_forgot' => 'user#password_forgot'
    #   get 'password_reset' => 'user#password_edit'
    #   get 'create' => 'user#regist'

    #   post 'login' => 'user#login'
    #   post 'create' => 'user#create'
    #   post 'password_forgot' => 'user#email_exist'
    #   patch 'password_reset' => 'user#password_reset'
  ...
  # get 'message/add/:id' => 'message#message_list_add'
  # get 'message/history/:id' => 'message#get_history'
  # scope '/messages', controller: 'message' do
  #   get 'list', to: 'view'
  ...
  # 後継者ページ
  resources :heirs, only: %i[show edit] do
    get 'heir/show' => 'heir#heir_show'
    get 'heir/edit' => 'heir#heir_edit'
  end
